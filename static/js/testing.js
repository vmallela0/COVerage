var fips = {
  ...
  for (var i = 0; i < fips.table.rows.length; i++) {
    county_identifier = fips.table.rows[i][1]
    county_name = county_identifier.substring(3, county_identifier.length) + " County, " + county_identifier.substring(0,2)
